...
public class Paint extends JFrame {
  ...
  public Paint(int width, int height) {
    ...
    this.btnUnDo = new JButton("ATRAS");
    this.btnClear = new JButton("BORRAR");
    this.coBoxColor = new JComboBox<String>(new String[] { "ROJO", "VERDE", "AZUL", "AZUL CLARO", "MORADO", "AMARILLO","NEGRO","NARANJA","ROSA","NEGRO","GRIS","AMARILLO FUERTE",
        "LAPIS LAZULI","MORADO SUAVE","AZUL CIELO","VERDE SUAVE","VERDE LUMINOSO","MAGENTA","AZUL MAR OSCURO"});
    
    this.coBoxShape = new JComboBox<String>(new String[] { "RECTANGULO", "CIRCULO", "LINEA","TRIANGULO" });
    this.chBoxIsFilled = new JCheckBox("LLENADO");
  ...
  public void addAttributes() {
    this.setTitle("GUI de dibujo interactivo");
